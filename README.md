#  &#128214; JustBook 소개
### 평소 국내 책 판매 사이트를 이용하면서 책 이외에 마스크, 헤어드라이기 같은 상품들을 판매하는것을 보았습니다. 

### 책 이외에 다른 상품들을 판매하는 문제 때문에 제가 원하는 책을 고르는데 어려움을 느꼈고 단순 책만 판매 하는 어플리케이션이 있으면 좋겠다는 생각이 들어 만들게 되었습니다
